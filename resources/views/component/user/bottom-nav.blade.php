    <div class="bottom-nav bg-white row position-fixed bottom-0 p-2 d-flex d-md-none">
        <div class="col d-flex justify-content-center align-items-center">
            <a href="{{ route('explore') }}" class="{{ Route::is('explore') ? 'text-warning' : 'text-gray' }} ">
                <i class="fas fa-home" style="font-size: 36px"></i>
            </a>
        </div>
        <div class="col d-flex justify-content-center align-items-center">
            <a data-toggle="modal" data-target="#modal-setting"
                class="text-secondary  {{ request()->is('setting/*') ? 'text-warning' : 'text-gray' }} ">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Settings Menu</h4>
